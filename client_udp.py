...
def send_message(client_socket, username, SERVER_IP, SERVER_PORT):
    while True:
        message = input()
...
def main():
    ...
    try:
        ...
        send_thread = threading.Thread(target=send_message, args=(client_socket, username, SERVER_IP, SERVER_PORT))
        send_thread.start()
